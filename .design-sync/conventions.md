...
```html
<div
  style="border-radius:10px;border:1px solid rgba(255,255,255,0.08);overflow:hidden;max-width:400px;"
>
  <div
    style="display:flex;align-items:center;gap:8px;padding:10px 12px;background:rgba(255,255,255,0.02);"
  >
  ...
  <div
    style="padding:5px 12px;background:rgba(255,255,255,0.02);border-top:1px solid rgba(255,255,255,0.05);font-size:10px;color:var(--c-dim);"
  >
