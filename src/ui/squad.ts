      ...
      return div({ style: { marginBottom: '8px' } },
        ...
        div({ style: { display: 'flex', flexWrap: 'wrap' } },
          ...lp.map(p => {
            ...
            return span({
              style: { display: 'inline-flex', alignItems: 'center', gap: '3px', padding: '2px 6px', borderRadius: '4px', fontSize: '11px', marginRight: '3px', marginBottom: '3px', background: LC[p.league] + '28', color: '#cbd5e1', border: '1px solid ' + LC[p.league] + '44' },
